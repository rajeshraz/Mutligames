...
export default function ColorTapGame({ route, navigation }) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.level}>Color Tap - Level {level}</Text>
      <Text style={styles.timer}>Time Left: {timeLeft}s</Text>
      <Text style={styles.mode}>{mode.charAt(0).toUpperCase() + mode.slice(1)} Mode</Text>
      
      <View style={styles.gameArea}>
        <Text style={styles.placeholder}>Color Tap Game</Text>
